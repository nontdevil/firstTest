...
enterPassword = glooey.Form("Enter your password: ")
button = glooey.Button("Check Password")
result = glooey.Label("")

def buttonClicked(widget):
    if enterPassword.text == "1234" or enterPassword.text == "123456" or enterPassword.text == "12345678" or enterPassword.text == "password" or enterPassword == "qwerty":
